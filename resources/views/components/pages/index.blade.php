                            ...
                            <div class="promotional_tour_slider owl-theme owl-carousel dot_style">
                                <div class="theme_common_box_two img_hover">
                                    ...
                                    <div class="theme_two_box_content">
                                        <h4><a href="{{route('adventure-details')}}">Kantua hotel, Thailand</a></h4>
                                        <p>Invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos
                                            et
                                            accusam et justo duo dolores et ea rebum. Stet clita kasd dolor sit amet. Lorem
                                ...
                                <div class="theme_common_box_two img_hover">
                                    <div class="theme_two_box_img">
                                        <a href="{{route('adventure-details')}}"><img src="{{asset('assets/img/tab-img/hotel2.png')}}"
                                                                          alt="img"></a>
                                    ...
                                    <div class="theme_two_box_content">
                                        <h4><a href="{{route('adventure-details')}}">Hotel paradise international</a></h4>
                                        <p>Invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos
                                            et
                                            accusam et justo duo dolores et ea rebum. Stet clita kasd dolor sit amet. Lorem
                                            ipsum dolor sit amet.</p>
                                ...
                                <div class="theme_common_box_two img_hover">
                                    <div class="theme_two_box_img">
                                        <a href="{{route('adventure-details')}}"><img src="{{asset('assets/img/tab-img/hotel3.png')}}"
                                                                          alt="img"></a>
                                        <p><i class="fas fa-map-marker-alt"></i>Kualalampur</p>
                                    </div>
                                    <div class="theme_two_box_content">
                                        <h4><a href="{{route('adventure-details')}}">Hotel kualalampur</a></h4>
                                        <p>Invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos
                                            et
                                            accusam et justo duo dolores et ea rebum. Stet clita kasd dolor sit amet. Lorem
                                            ipsum dolor sit amet.</p>
                                ...
                                <div class="theme_common_box_two img_hover">
                                    <div class="theme_two_box_img">
                                        <a href="{{route('adventure-details')}}"><img src="{{asset('assets/img/tab-img/hotel4.png')}}"
                                                                          alt="img"></a>
                                    ...
                                    <div class="theme_two_box_content">
                                        <h4><a href="{{route('adventure-details')}}">Hotel deluxe</a></h4>
                                        <p>Invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos
                                            et
                                            accusam et justo duo dolores et ea rebum. Stet clita kasd dolor sit amet. Lorem
                                            ipsum dolor sit amet.</p>
                                ...
                                <div class="theme_common_box_two img_hover">
                                    <div class="theme_two_box_img">
                                        <a href="{{route('adventure-details')}}"><img src="{{asset('assets/img/tab-img/hotel6.png')}}"
                                                                          alt="img"></a>
                                        <p><i class="fas fa-map-marker-alt"></i>Beach view</p>
                                    </div>
                                    <div class="theme_two_box_content">
                                        <h4><a href="{{route('adventure-details')}}">Thailand grand suit</a></h4>
                                        <p>Invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos
                                            et
                                            accusam et justo duo dolores et ea rebum. Stet clita kasd dolor sit amet. Lorem
                                            ipsum dolor sit amet.</p>
                                ...
                                <div class="theme_common_box_two img_hover">
                                    <div class="theme_two_box_img">
                                        <a href="{{route('adventure-details')}}"><img src="{{asset('assets/img/tab-img/hotel7.png')}}"
                                                                          alt="img"></a>
                                        <p><i class="fas fa-map-marker-alt"></i>Long island</p>
                                    </div>
                                    <div class="theme_two_box_content">
                                        <h4><a href="{{route('adventure-details')}}">Zefi resort and spa</a></h4>
                                        <p>Invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos
                                            et
                                            accusam et justo duo dolores et ea rebum. Stet clita kasd dolor sit amet. Lorem
                                            ipsum dolor sit amet.</p>
