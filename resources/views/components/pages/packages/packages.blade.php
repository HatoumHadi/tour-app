                        ...
                        <div class="row">
                            <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                                <div class="top_destinations_box img_hover">
                                    ...
                                    <a href="{{route('package-details')}}"><img src="assets/img/destination/main-page1.png"
                                                                                 alt="img"></a>
                                    <div class="top_destinations_box_content">
                                        <h4><a href="{{route('package-details')}}">Ancient egypt</a></h4>
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                                <div class="top_destinations_box img_hover">
                                    ...
                                    <a href="{{route('package-details')}}"><img src="assets/img/destination/main-page2.png"
                                                                                 alt="img"></a>
                                    <div class="top_destinations_box_content">
                                        <h4><a href="{{route('package-details')}}">Explore china</a></h4>
                                        <p><span class="review_rating">4.8/5 Excellent</span> <span
                                                class="review_count">(1214
                                            reviewes)</span></p>
                                        <h3>$99.00 <span>Price starts from</span></h3>
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                                <div class="top_destinations_box img_hover">
                                    ...
                                    <a href="{{route('package-details')}}"><img src="assets/img/destination/main-page3.png"
                                                                                 alt="img"></a>
                                    <div class="top_destinations_box_content">
                                        <h4><a href="{{route('package-details')}}">Annapurna</a></h4>
                                        <p><span class="review_rating">4.8/5 Excellent</span> <span
                                                class="review_count">(1214
                                            reviewes)</span></p>
                                        <h3>$99.00 <span>Price starts from</span></h3>
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                                <div class="top_destinations_box img_hover">
                                    ...
                                    <a href="{{route('package-details')}}"><img src="assets/img/destination/main-page4.png"
                                                                                 alt="img"></a>
                                    <div class="top_destinations_box_content">
                                        <h4><a href="{{route('package-details')}}">Beautiful darjeeling</a></h4>
                                        <p><span class="review_rating">4.8/5 Excellent</span> <span
                                                class="review_count">(1214
                                            reviewes)</span></p>
                                        <h3>$99.00 <span>Price starts from</span></h3>
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                                <div class="top_destinations_box img_hover">
                                    ...
                                    <a href="{{route('package-details')}}"><img src="assets/img/destination/main-page5.png"
                                                                                 alt="img"></a>
                                    <div class="top_destinations_box_content">
                                        <h4><a href="{{route('package-details')}}">Himalaya</a></h4>
                                        <p><span class="review_rating">4.8/5 Excellent</span> <span
                                                class="review_count">(1214
                                            reviewes)</span></p>
                                        <h3>$99.00 <span>Price starts from</span></h3>
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                                <div class="top_destinations_box img_hover">
                                    ...
                                    <a href="{{route('package-details')}}"><img src="assets/img/destination/main-page6.png"
                                                                                 alt="img"></a>
                                    <div class="top_destinations_box_content">
                                        <h4><a href="{{route('package-details')}}">Kathmundu</a></h4>
                                        <p><span class="review_rating">4.8/5 Excellent</span> <span
                                                class="review_count">(1214
                                            reviewes)</span></p>
                                        <h3>$99.00 <span>Price starts from</span></h3>
