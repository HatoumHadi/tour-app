...
use App\Filament\Resources\Requests\HotelResource\Pages;
...
//                    ->dateTime(),
    ...
    {
        return [
            'index' => Requests\HotelResource\Pages\ListHotels::route('/'),
            'create' => Requests\HotelResource\Pages\CreateHotel::route('/create'),
            'edit' => Requests\HotelResource\Pages\EditHotel::route('/{record}/edit'),
        ];
    }
}
