...
class CarRentalPolicy
{
    ...
    {
        return $user->can('view_any_requests::car::rental');
    }
    ...
    {
        return $user->can('view_requests::car::rental');
    }
    ...
    {
        return $user->can('create_requests::car::rental');
    }
    ...
    {
        return $user->can('update_requests::car::rental');
    }
    ...
    {
        return $user->can('delete_requests::car::rental');
    }
    ...
    {
        return $user->can('delete_any_requests::car::rental');
    }
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function replicate(User $user, CarRental $carRental)
    {
