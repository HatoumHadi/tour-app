...
class TransportationPolicy
{
    ...
    {
        return $user->can('view_any_requests::transportation');
    }
    ...
    {
        return $user->can('view_requests::transportation');
    }
    ...
    {
        return $user->can('create_requests::transportation');
    }
    ...
    {
        return $user->can('update_requests::transportation');
    }
    ...
    {
        return $user->can('delete_requests::transportation');
    }
    ...
    {
        return $user->can('delete_any_requests::transportation');
    }
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function replicate(User $user, Transportation $transportation)
    {
